      ...
      <ViewPager
        ...
        <View key="1">
          <TouchableWithoutFeedback
            ...
            <FastImage
              source={{uri: productData.main_image, priority: FastImage.priority.high}}
              style={{
                width: '100%',
                height: 400,
              }}
        ...
        {productData.sub_image_1 !== '' && (
          <View key="2">
            <TouchableWithoutFeedback
              ...
              <FastImage
                source={{uri: productData.sub_image_1,priority: FastImage.priority.high}}
                style={{
                  width: '100%',
                  height: 400,
                }}
        ...
        {productData.sub_image_2 !== '' && (
          <View key="3">
            <TouchableWithoutFeedback
              ...
              <FastImage
                source={{uri: productData.sub_image_2, priority: FastImage.priority.high}}
                style={{
                  width: '100%',
                  height: 400,
                }}
        ...
        {productData.sub_image_3 !== '' && (
          <View key="4">
            <TouchableWithoutFeedback
              ...
              <FastImage
                source={{uri: productData.sub_image_3, priority: FastImage.priority.high}}
                style={{
                  width: '100%',
                  height: 300,
                }}
          ...
          <TouchableOpacity>
            <View style={{width: 80, height: 80, marginRight: 10}}>
              <TouchableWithoutFeedback
                onPress={handleImagePreivew.bind(this, productData.main_image)}>
                <FastImage
                  source={{uri: productData.main_image, priority: FastImage.priority.normal}}
                  style={{
                    width: '100%',
                    height: '100%',
                  }}
